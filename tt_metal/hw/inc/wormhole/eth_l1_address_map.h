...
struct address_map {
    ...
    static constexpr std::int32_t MAX_L1_LOADING_SIZE = 0x3E000;
    ...
    // ERISC UNRESERVED space starting from SW_MANAGED_L1_BASE on systems with routing FW and ROUTING_FW_RESERVED_BASE
    // on systems without MAX is MAX_L1_LOADING_SIZE
    static constexpr std::int32_t ERISC_L1_UNRESERVED_BASE = SW_MANAGED_L1_BASE;
    ...
    static constexpr std::int32_t ROUTING_DISABLED_ERISC_L1_UNRESERVED_SIZE =
        MAX_L1_LOADING_SIZE - ROUTING_DISABLED_ERISC_L1_UNRESERVED_BASE;

    static_assert((ERISC_L1_UNRESERVED_BASE % 32) == 0);

    // CONFIG SPACE starting from MAX_L1_LOADING_SIZE to MAX_SIZE
    ...
    static constexpr std::int32_t ERISC_APP_ROUTING_INFO_BASE = MAX_L1_LOADING_SIZE;
